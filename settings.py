...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/romek/PycharmProjects/kitty/articles.sqlite3',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/romek/PycharmProjects/kitty/static/'
...
STATICFILES_DIRS = (
    ...
    '/home/romek/PycharmProjects/kitty/static',
)
...
SECRET_KEY = 'imzjmrh(r7m%)i24kcdj9j0^ri#6qan$gw_f_%id-0(@zar5@y'
